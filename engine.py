...
class MainWindow(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.instructions.setPlainText(
            ...
            "   Purple Dot     : Current EKF Mean Belief\n"
            "   Green Rings    : Uncertainty Ellipses (P-Matrix)\n"
            "                    - Inner: 50% Confidence Interval\n"
            "                    - Outer: 95% Confidence Interval\n"
            ...
            "   - Agent relies on recursive prediction (Dead-Reckoning).\n"
            ...
            "   - Agent performs 'Stop-and-Scan' behavior represented by Periodic EKF Measurement Updates (h).\n"
            "   - EXPECTATION: Heading drift is bounded; Home is reached.\n\n"

            "=== PARAMETER GUIDE ===\n"
            "Heading Bias Mean : Systematic Drift\n"
            "Heading Bias Std  : Run-to-run bias variability\n"
            "Heading Noise     : Stochastic angular jitter (Process Noise)\n"
            ...
            "--- Estimator (EKF) ---\n"
            "Sun Sensor Std    : Measurement noise (R-Matrix). Controls\n"
            "                    Kalman Gain (K) and update 'snap'.\n"
            "EKF Trust Scale   : Multiplier for Q-Matrix. Higher values\n"
            "                    induce filter 'pessimism' (faster P growth).\n\n"
